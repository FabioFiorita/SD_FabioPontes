...
//		Produto p3 = new Produto("Plainaa");
...
//
//		NotaCompraItem i1_1 = new NotaCompraItem(2, nc1, p1, new BigDecimal("300.00"));
//		NotaCompraItem i1_2 = new NotaCompraItem(2, nc1, p2, new BigDecimal("1000.00"));
//		NotaCompraItem i1_3 = new NotaCompraItem(2, nc1, p3, new BigDecimal("500.00"));
//		i1_1 = notaCompraService.salvar(i1_1);
//		i1_2 = notaCompraService.salvar(i1_2);
//		i1_3 = notaCompraService.salvar(i1_3);
//
//		NotaCompraItem i2_1 = new NotaCompraItem(7, nc2, p4, new BigDecimal("400.00"));
//		NotaCompraItem i2_2 = new NotaCompraItem(2, nc2, p2, new BigDecimal("1000.00"));
//		NotaCompraItem i2_3 = new NotaCompraItem(1, nc2, p5, new BigDecimal("700.00"));
